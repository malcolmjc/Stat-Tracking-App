...
import { MockUserChartsComponent } from '../user-charts/user-charts.component.mock';
import { MockUserStatsComponent } from '../user-stats/user-stats.component.mock';
...
describe('UserLeaderboardComponent', () => {
  ...
  describe('ascending and descending stat filters', () => {
    test('set ascending works', () => {
      ...
      expect(component.onSelection).toHaveBeenCalledWith(null);
    });
